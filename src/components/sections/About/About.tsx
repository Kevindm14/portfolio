export const About = () => {
	return (
		<section
			id="about"
			className={`flex flex-col lg:flex-row-reverse lg:justify-between bg-honeyDew`}
		>
			<div className="text-white px-5 py-40 flex justify-center text-center flex-col items-center lg:w-1/2 lg:px-36">
				<h2 className='mb-10 font-extrabold text-spaceCadet text-6xl uppercase text-center'>Acerca de mi</h2>
				<p className='text-lg text-spaceCadet'>
			...
			<div className="lg:w-1/2">
				<img src={`/about_me.webp`} className="h-full w-full" alt="profile" />
			</div>
		</section>
	)
}
